...
public class EditBandAlbumsPage extends WebPage {
	...
	private BandAddController controller;

	public EditBandAlbumsPage(BandAddController _controller) {
		super();
	...
	protected void fillMainData() {
		CompoundPropertyModel<BandAddController> controllerModel = new CompoundPropertyModel<>(this.controller);
